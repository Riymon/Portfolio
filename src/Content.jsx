  ...
  let arr = [];
   if(content.title == 'Projects'){
     arr = [
        ...
        {id:2, h: 'Medical Clinic Appointment System', img: mclinic, p: 'TEST', a: 'https://riymon.github.io/Medical-Clinic-Appointment-System/'},
    ...
    <div className="text1 grid grid-cols-3 gap-4 h-auto my-5 p-4">
        {arr.map((arrs) => (
          <div key={arrs.id} className="content custom-gradient">
            ...
            <a className='' href={arrs.a}>{arrs.p}</a>
          </div>
        ))}
    </div>
    </>
